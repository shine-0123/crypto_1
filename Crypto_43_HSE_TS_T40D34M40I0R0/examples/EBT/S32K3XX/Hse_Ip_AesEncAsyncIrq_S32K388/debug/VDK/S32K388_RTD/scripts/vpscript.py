...
import imp
Breakpoints = []
test_mem_name = '/S32K388_System/S32K388_MCU/Memories/TEST_MEM/m_memory'
...
def create_simprobes(core_name):
    ...
    core =""
    if core_name == "CM7_0":
        core ='S32K388_System.S32K388_MCU.CPU_SS.CLUSTER_0.cpu0'
    if core_name == "CM7_1":
        core ='S32K388_System.S32K388_MCU.CPU_SS.CLUSTER_1.cpu0'
    if core_name == "CM7_2":
        core ='S32K388_System.S32K388_MCU.CPU_SS.CLUSTER_2.cpu0'
    if core_name == "CM7_3":
        core ='S32K388_System.S32K388_MCU.CPU_SS.CLUSTER_3.cpu0'
...
def boot_setup(core_num, start_address):
    TEST_MEM ='/S32K388_System/S32K388_MCU/Memories/TEST_MEM'
