...
#define HSE_IP_HSE_CHANNEL_BUSY_MASK_U32     (0x0000FFFFUL)
    ...
    #define HSE_IP_PTR_TO_HOST_ADDR (HOST_ADDR)(uint64) 
#else
    #define HSE_IP_PTR_TO_HOST_ADDR (HOST_ADDR)(uint32)
#endif
/*==================================================================================================
*                                         LOCAL CONSTANTS
==================================================================================================*/
...
)
{
    ...
    else
    {
        ...
        if (HSE_IP_REQTYPE_SYNC == pRequest->eReqType)
        {
            ...
            Mu_Ip_SetTxRegister(Hse_Ip_apMuBase[u8MuInstance], u8MuChannel, HSE_IP_PTR_TO_HOST_ADDR (pHseSrvDesc));
